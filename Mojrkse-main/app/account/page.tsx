...
export default async function AccountPage() {
  ...
  return (
    <div className="container mx-auto max-w-5xl px-4 py-14">
      ...
      <p className="mt-3 text-muted-foreground">إدارة بياناتك والانتقال السريع إلى الطلبات والأمان.</p>
        ...
        <Card>
          ...
          <CardContent className="space-y-3">
            ...
            <Link href="/forgot-password">
              <Button variant="outline" className="w-full">إعادة تعيين كلمة السر</Button>
            </Link>
            <Link href="/faq">
